...
public class TicketService {
    ...
    public TicketEntity saveBasePrice(TicketEntity ticket){
        ...
        ResponseEntity<List<Repair>> response = restTemplate.exchange(
                "http://gateway-service:8080/api/v1/repair/byticket/" + ticketId,
                HttpMethod.GET,
                null,
        ...
        int engineType = restTemplate.getForObject("http://gateway-service:8080/api/v1/vehicle/engineType/" + ticket.getLicensePlate(), Integer.class);
        ...
        for (Repair repair : repairs) {
            ...
            restTemplate.put("http://gateway-service:8080/api/v1/repair/setBasePrice", basePriceRequest);
            // Fetch the updated Repair object
            ResponseEntity<Repair> updatedRepairResponse = restTemplate.exchange(
                    "http://gateway-service:8080/api/v1/repair/" + repair.getIdRepair(),
                    HttpMethod.GET,
                    null,
    ...
    public TicketEntity saveKMSurcharge(TicketEntity ticket){
        ...
        for (Repair repair : repairs) {
            restTemplate.put("http://gateway-service:8080/api/v1/repair/calculateKMSurcharge/" + percentageKMSurcharge, repair);
            Repair updatedRepair = restTemplate.getForObject("http://gateway-service:8080/api/v1/repair/" + repair.getIdRepair(), Repair.class);
    ...
    public TicketEntity saveAgeSurcharge(TicketEntity ticket){
        ...
        for (Repair repair : repairs) {
            restTemplate.put("http://gateway-service:8080/api/v1/repair/calculateAgeSurcharge/" + percentageAgeSurcharge, repair);
            Repair updatedRepair = restTemplate.getForObject("http://gateway-service:8080/api/v1/repair/" + repair.getIdRepair(), Repair.class);
    ...
    public TicketEntity saveSurchargeForDelay(TicketEntity ticket){
        ...
        for (Repair repair : repairs) {
            ...
            restTemplate.put("http://gateway-service:8080/api/v1/repair/calculateDelaySurcharge/" + percentageDelaySurcharge, repair);
            // Fetch the updated Repair object
    ...
    public TicketEntity saveDiscountByDay(TicketEntity ticket){
        ...
        for (Repair repair : repairs) {
            restTemplate.put("http://gateway-service:8080/api/v1/repair/calculateDiscountByDay", repair);
            Repair updatedRepair = restTemplate.getForObject("http://gateway-service:8080/api/v1/repair/" + repair.getIdRepair(), Repair.class);
    ...
    public TicketEntity saveTotalPrice(TicketEntity ticket){
        ...
        ResponseEntity<List<Repair>> response = restTemplate.exchange(
                "http://gateway-service:8080/api/v1/repair/byticket/" + ticket.getIdTicket(),
                HttpMethod.GET,
                null,
                new ParameterizedTypeReference<List<Repair>>() {}
        );
